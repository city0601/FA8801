...
#ifndef __FITI_SYSTEM_GPIO_H
#define __FITI_SYSTEM_GPIO_H
...
FlagStatus gpio_input_data_bit_read(gpio_type *gpio_x, uint16_t pins);
uint16_t gpio_input_data_read(gpio_type *gpio_x);
FlagStatus gpio_output_data_bit_read(gpio_type *gpio_x, uint16_t pins);
